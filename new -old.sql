...
MySQL - 5.5.5-10.1.10-MariaDB : Database - triptroo_database
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`triptroo_database` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `triptroo_database`;
...
CREATE TABLE `chat` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_chat_2_idx` (`uname`),
  KEY `fk_chat_1_idx` (`room`),
  CONSTRAINT `fk_chat_1` FOREIGN KEY (`room`) REFERENCES `room` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_chat_2` FOREIGN KEY (`uname`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
insert  into `countries`(id,name,latitude,longitude,zoom,ads) values (1,'Indonesia',-2.548926,118.0148634,5,NULL);
...
CREATE TABLE `event` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_event_1_idx` (`submit`),
  KEY `fk_event_2_idx` (`place_id`),
  CONSTRAINT `fk_event_1` FOREIGN KEY (`submit`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_event_2` FOREIGN KEY (`place_id`) REFERENCES `place` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `feedback` (
  ...
  `timesubmit` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_feedback_1_idx` (`submit`),
  CONSTRAINT `fk_feedback_1` FOREIGN KEY (`submit`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `news` (
  ...
  `timesubmit` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `desc` tinytext,
  `prior` tinyint(4) DEFAULT '5',
  `city` int(11) DEFAULT NULL,
  `updated` timestamp NULL DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `flags` tinyint(4) DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `fk_news_1_idx` (`submit`),
  KEY `fk_news_2_idx` (`city`),
  CONSTRAINT `fk_news_1` FOREIGN KEY (`submit`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_news_2` FOREIGN KEY (`city`) REFERENCES `cities` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `notif` (
  ...
  `messages` varchar(150) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_notif_2_idx` (`uname`),
  KEY `fk_notif_3_idx` (`from`),
  KEY `fk_notif_1_idx` (`room`),
  CONSTRAINT `fk_notif_1` FOREIGN KEY (`room`) REFERENCES `room` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_notif_2` FOREIGN KEY (`uname`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_notif_3` FOREIGN KEY (`from`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `notif` */

/*Table structure for table `opentrip` */

DROP TABLE IF EXISTS `opentrip`;
...
CREATE TABLE `opentrip` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_opentrip_1_idx` (`organizer`),
  KEY `fk_opentrip_2_idx` (`start_city`),
  CONSTRAINT `fk_opentrip_1` FOREIGN KEY (`organizer`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_opentrip_2` FOREIGN KEY (`start_city`) REFERENCES `cities` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `opentrip` */
...
CREATE TABLE `parti` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_parti_history_1_idx` (`user`),
  KEY `fk_parti_history_2_idx` (`trip_id`),
  KEY `fk_parti_history_3_idx` (`updated_by`),
  CONSTRAINT `fk_parti_history_1` FOREIGN KEY (`user`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_parti_history_2` FOREIGN KEY (`trip_id`) REFERENCES `opentrip` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_parti_history_3` FOREIGN KEY (`updated_by`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `photos` (
  ...
  `submit` int(11) DEFAULT NULL,
  `timesubmit` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `used_tb` varchar(45) COLLATE utf8_czech_ci DEFAULT NULL,
  ...
  `flags` tinyint(4) DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `fk_photos_1_idx` (`submit`),
  KEY `fk_photos_2_idx` (`city`),
  CONSTRAINT `fk_photos_1` FOREIGN KEY (`submit`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_photos_2` FOREIGN KEY (`city`) REFERENCES `cities` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `place` (
  ...
  `stay_star` tinyint(4) DEFAULT NULL,
  `country` int(11) DEFAULT NULL,
  `region` int(11) DEFAULT NULL,
  `city` int(11) DEFAULT NULL,
  `latitude` double DEFAULT NULL,
  `longitude` double DEFAULT NULL,
  `zoom` int(11) DEFAULT NULL,
  `gsm_pict` varchar(255) DEFAULT NULL,
  `rate` int(11) DEFAULT NULL,
  `total_rev` int(11) DEFAULT NULL,
  `pricelow` int(11) DEFAULT NULL,
  `pricehi` int(11) DEFAULT NULL,
  `days` tinytext,
  `opentime` tinytext,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_place_1_idx` (`submit`),
  KEY `fk_place_2_idx` (`city`),
  KEY `fk_place_3_idx` (`subtype`),
  KEY `fk_place_4_idx` (`type`),
  KEY `fk_place_2_idx1` (`region`),
  KEY `fk_place_6_idx` (`country`),
  CONSTRAINT `fk_place_1` FOREIGN KEY (`submit`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_place_2` FOREIGN KEY (`region`) REFERENCES `regions` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_place_3` FOREIGN KEY (`city`) REFERENCES `cities` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_place_4` FOREIGN KEY (`subtype`) REFERENCES `subtype_place` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_place_5` FOREIGN KEY (`type`) REFERENCES `type_place` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_place_6` FOREIGN KEY (`country`) REFERENCES `countries` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
/*Table structure for table `rank_point` */

DROP TABLE IF EXISTS `rank_point`;

CREATE TABLE `rank_point` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `rank_id` int(11) DEFAULT NULL,
  `point` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_table1_1_idx` (`rank_id`),
  CONSTRAINT `fk_table1_1` FOREIGN KEY (`rank_id`) REFERENCES `rank` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `rank_point` */
...
CREATE TABLE `report` (
  ...
  `timesubmit` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_report_1_idx` (`submit`),
  CONSTRAINT `fk_report_1` FOREIGN KEY (`submit`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `review` (
  ...
  `flags` tinyint(4) DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `fk_review_1_idx` (`place_id`),
  KEY `fk_review_2_idx` (`submit`),
  KEY `fk_review_3_idx` (`place_type`),
  CONSTRAINT `fk_review_1` FOREIGN KEY (`place_id`) REFERENCES `place` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_review_2` FOREIGN KEY (`submit`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_review_3` FOREIGN KEY (`place_type`) REFERENCES `type_place` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
/*Table structure for table `subtype_place` */

DROP TABLE IF EXISTS `subtype_place`;

CREATE TABLE `subtype_place` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL,
  `type_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_subtype_place_1_idx` (`type_id`),
  CONSTRAINT `fk_subtype_place_1` FOREIGN KEY (`type_id`) REFERENCES `type_place` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `subtype_place` */
...
CREATE TABLE `user` (
  ...
  `photos_post` int(11) DEFAULT NULL,
  `place_total` int(11) DEFAULT NULL,
  `place_stay` int(11) DEFAULT NULL,
  `place_culinary` int(11) DEFAULT NULL,
  `place_attraction` int(11) DEFAULT NULL,
  `place_nightlife` int(11) DEFAULT NULL,
  `place_shopping` int(11) DEFAULT NULL,
  `review_total` int(11) DEFAULT NULL,
  `review_stay` int(11) DEFAULT NULL,
  `review_culinary` int(11) DEFAULT NULL,
  `review_attraction` int(11) DEFAULT NULL,
  `review_nightlife` int(11) DEFAULT NULL,
  `review_shopping` int(11) DEFAULT NULL,
  `lastlog` timestamp NULL DEFAULT NULL,
  `flags` tinyint(4) DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_user_3_idx` (`rank`),
  KEY `fk_user_1_idx` (`city`),
  KEY `fk_user_2_idx` (`region`),
  CONSTRAINT `fk_user_1` FOREIGN KEY (`city`) REFERENCES `cities` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_2` FOREIGN KEY (`region`) REFERENCES `regions` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_3` FOREIGN KEY (`rank`) REFERENCES `rank` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

/*Data for the table `user` */

insert  into `user`(id,uname,pass,fullname,role,rank,join_date,phone,email,website,region,city,bio,born,gender,photos_post,place_total,place_stay,place_culinary,place_attraction,place_nightlife,place_shopping,review_total,review_stay,review_culinary,review_attraction,review_nightlife,review_shopping,lastlog,flags) values (1,'080212','202cb962ac59075b964b07152d234b70','ripas',NULL,NULL,'2016-07-27 01:17:32','ripas','rif2602@gmail.com',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1),(2,'080212','202cb962ac59075b964b07152d234b70','ripas',NULL,NULL,'2016-07-27 01:17:47','ripas','rif2602@gmail.com',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1),(3,'080212','202cb962ac59075b964b07152d234b70','ripas',NULL,NULL,'2016-07-27 01:18:46','ripas','rif2602@gmail.com',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1),(4,'080212','202cb962ac59075b964b07152d234b70','ripas',NULL,NULL,'2016-07-27 01:22:47','ripas','rif2602@gmail.com',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1),(5,'080212','202cb962ac59075b964b07152d234b70','ripas',NULL,NULL,'2016-07-27 01:27:05','ripas','rif2602@gmail.com',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1),(6,'ripas','202cb962ac59075b964b07152d234b70','ripas',NULL,NULL,'2016-07-27 01:28:31','08080','rif2602@gmail.com',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1),(7,'ripas','202cb962ac59075b964b07152d234b70','ripas',NULL,NULL,'2016-07-27 01:28:48','08080','rif2602@gmail.com',NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1);
...
CREATE TABLE `user_medals` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_userbedges_1_idx` (`medal_id`),
  KEY `fk_userbedges_2_idx` (`uname`),
  CONSTRAINT `fk_userbedges_1` FOREIGN KEY (`medal_id`) REFERENCES `medals` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_userbedges_2` FOREIGN KEY (`uname`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `user_medals` */

/*Table structure for table `user_tourguide` */

DROP TABLE IF EXISTS `user_tourguide`;

CREATE TABLE `user_tourguide` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uname` int(11) DEFAULT NULL,
  `language` varchar(50) DEFAULT NULL,
  `area` varchar(50) DEFAULT NULL,
  `tourcat` varchar(45) DEFAULT NULL,
  `updated` timestamp NULL DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_user_tourgide_1_idx` (`uname`),
  CONSTRAINT `fk_user_tourgide_1` FOREIGN KEY (`uname`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `user_tourguide` */
